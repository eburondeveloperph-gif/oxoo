...
import { BEATRICE_SYSTEM_PROMPT } from './prompts';
...
const toolsets: Record<Template, FunctionCall[]> = {
  ...
  'personal-assistant': [...personalAssistantTools, ...workspaceTools, ...whatsappTools, ...documentTools],
...
const systemPrompts: Record<Template, string> = {
  ...
  'personal-assistant': BEATRICE_SYSTEM_PROMPT,
...
export const useUI = create<{
  ...
  setIsWorkspaceFullScreen: (isFull: boolean) => void;
